...
@section('content')
      ...
      <section class="main-slider-one" id="home">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="about-one__image wow fadeInLeft " data-wow-delay="00ms">
                            <img src="{{ asset('assets/images/backgrounds/WhatsApp Image 2025-11-03 at 19.38.45.jpeg') }}" alt="procounsel">
        ...
        <section class="why-choose-one">
            <div class="why-choose-one__bg" style="background-image: url(assets/images/backgrounds/why-choose-bg.jpg);"></div>
            <div class="container-fluid">
                <div class="row justify-content-center gutter-y-30">
                    <div class="col-xl-3">
                        <div class="why-choose-one__left">
                            <img src="assets/images/resources/why-choose-1-2.jpg" alt="procounsel">
                        </div>
                    </div>
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="why-choose-one__content">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-in-up">A strategic ally for <br> <span>Ghana’s decision-makers</span></h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <p class="why-choose-one__text">
                                We act as embedded advisors for leadership teams tackling capital raises, regulatory change, and high-stakes disputes—delivering counsel that balances precision with pragmatic execution.
                            </p>
                            <a href="#consult" class="procounsel-btn ">
                                <i>Speak with Counsel</i>
                            ...
                            <div class="why-choose-one__item">
                                <div class="why-choose-one__experiance count-box">
                                    ...
                                    <p class="why-choose-one__experiance__text">Years Guiding Clients</p>
                                </div>
                                <div class="why-choose-one__booking count-box">
                                    ...
                                    <p class="why-choose-one__booking__text">Dedicated Legal Partners</p>
                                </div>
                                <div class="why-choose-one__customers">
                                    ...
                                    <h3 class="why-choose-one__customers__text">Trusted Relationships</h3>
                                </div>
                    ...
                    <div class="col-xl-3">
                        <div class="why-choose-one__right">
                            <img src="assets/images/resources/why-choose-1-3.jpg" alt="procounsel">
                        </div>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container -->
        ...
        <section class="portfolio-one" id="caseStudy">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <h3 class="sec-title__title bw-split-in-up">Recent mandates that <br><span>Advanced client outcomes</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
            </div>
            <div class="container">
                <div class="portfolio-one__wrapper">
                    <div class="portfolio-one__item">
                        <img src="assets/images/portfolio/portfolio-1-1.jpg" alt="procounsel">
                        <div class="portfolio-one__item__rm">
                            <a href="portfolio-details.html"><i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="portfolio-one__item__content">
                            ...
                            <h3 class="portfolio-one__item__title">
                                <a href="portfolio-details.html">Series B Capital Restructure</a>
                            </h3>
                        </div>
                    </div><!-- item -->
                    <div class="portfolio-one__item">
                        <img src="assets/images/portfolio/portfolio-1-2.jpg" alt="procounsel">
                        <div class="portfolio-one__item__rm">
                            <a href="portfolio-details.html"><i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="portfolio-one__item__content">
                            <div class="portfolio-one__item__cat">
                                <i class="fa fa-map-marker-alt"></i>East Legon, Ghana
                            </div>
                            <h3 class="portfolio-one__item__title">
                                <a href="portfolio-details.html">Cross-Border JV Formation</a>
                            </h3>
                        </div>
                    </div><!-- item -->
                    <div class="portfolio-one__item active">
                        <img src="assets/images/portfolio/portfolio-1-3.jpg" alt="procounsel">
                        <div class="portfolio-one__item__rm">
                            <a href="portfolio-details.html"><i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="portfolio-one__item__content">
                            <div class="portfolio-one__item__cat">
                                <i class="fa fa-map-marker-alt"></i>Takoradi, Ghana
                            </div>
                            <h3 class="portfolio-one__item__title">
                                <a href="portfolio-details.html">Energy Sector Arbitration</a>
                            </h3>
                        </div>
                    </div><!-- item -->
        ...
        <section class="team-one">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <h3 class="sec-title__title bw-split-in-up">Meet the partners <br> <span>Advancing your agenda</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
                        ...
                        <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="team-card__image bw-img-anim-left">
                                ...
                                <div class="team-card__hover">
                                    <span class="team-card__hover__btn"><i class="fa fa-plus"></i></span>
        ...
        <section class="testimonials-one" id="testimonial">
            <div class="testimonials-one__bg" style="background-image: url(assets/images/shapes/testimonials-1-bg.png);"></div>
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <h3 class="sec-title__title bw-split-in-up">Leaders who rely on <br><span>Breman Chambers</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
				...
				"responsive": {
                        ...
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="assets/images/resources/testi-1-1.jpg" alt="Ama Boateng">
                                ...
                                <div class="testimonials-card__content">
                                    ...
                                    <p class="testimonials-card__designation">Managing Partner, Fintech Consortium</p><!-- /.testimonials-card__designation -->
                            ...
                            <div class="testimonials-card__desc">
                                “They internalised our capital strategy within days and negotiated investor terms that preserved valuation without slowing momentum.”
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="assets/images/resources/testi-1-2.jpg" alt="Kojo Mensah">
                                </div><!-- /.testimonials-card__image -->
                                <div class="testimonials-card__content">
                                    <div class="testimonials-card__quote">
                                        <i class="fa fa-quote-left"></i>
                                    ...
                                    <p class="testimonials-card__designation">CEO, Coastal Energy Holdings</p><!-- /.testimonials-card__designation -->
                                    <div class="testimonials-card__rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <div class="testimonials-card__desc">
                                “Breman Chambers managed our cross-border joint venture from regulatory clearance to closing—they anticipated every jurisdictional wrinkle.”
                            </div><!-- /.testimonials-card__desc -->
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="assets/images/resources/testi-1-3.jpg" alt="Nana Owusu">
                                </div><!-- /.testimonials-card__image -->
                                <div class="testimonials-card__content">
                                    <div class="testimonials-card__quote">
                                        <i class="fa fa-quote-left"></i>
                                    ...
                                    <p class="testimonials-card__designation">Chair, Meridian Family Office</p><!-- /.testimonials-card__designation -->
                                    <div class="testimonials-card__rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <div class="testimonials-card__desc">
                                “Their governance overhaul balanced family priorities with institutional discipline; we now execute decisions with clarity.”
                            </div><!-- /.testimonials-card__desc -->
        ...
        <section class="contact-one">
            <div class="contact-one__bg" style="background-image: url(assets/images/backgrounds/contact-1-bg.jpg);"></div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="contact-one__content">
                                <div class="contact-one__content__bg bw-img-anim-left" style="background-image: url(assets/images/resources/contact-1-1.jpg);"></div>
                                    ...
                                    <li class="contact-one__info__item">
                                        ...
                                        <div class="contact-one__info__content">
                                            <p class="contact-one__info__text">
                                                <a href="tel:+233244376601 0">+233 244 376 6010</a><br>
                                                <a href="tel:+233244376601 0">+233 244 376 6010</a>
                                    ...
                                    <li class="contact-one__info__item">
                                        ...
                                        <div class="contact-one__info__content">
                                            <p class="contact-one__info__text">
                                                ...
                                                <a href="https://bracketweb.com/procounsel-html/www.website.com">www.website.com</a>
                                            </p><!-- /.contact-one__info__text -->
                                        </div><!-- /.contact-one__info__content -->
                                    </li>
                                    <li class="contact-one__info__item">
				...
				"responsive": {
                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="blog-card__content">
                                <div class="blog-card__user">
                                    <img src="assets/images/blog/blog-user-1.jpg" alt="10 Simple Practices that Will Help You Get 1% " class="blog-card__user__img">
                            ...
                            <div class="blog-card__image">
                                <div class="blog-card__image__inner">
                                    <img src="assets/images/blog/blog-1-1.jpg" alt="10 Simple Practices that Will Help You Get 1% ">
                                    <img src="assets/images/blog/blog-1-1.jpg" alt="10 Simple Practices that Will Help You Get 1% ">
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="blog-card__content">
                                <div class="blog-card__user">
                                    <img src="assets/images/blog/blog-user-2.jpg" alt="We Can Aenean Poor leo Nec This Blog." class="blog-card__user__img">
                                    <div class="blog-card__user__info">
                                        <h3 class="blog-card__user__name">Ronald Richards</h3>
                                        <p class="blog-card__user__designation">Admin</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            <div class="blog-card__content">
                                <div class="blog-card__user">
                                    <img src="assets/images/blog/blog-user-3.jpg" alt="Aenean Sollicitudin Ieo Nunc, Ornare This Blog." class="blog-card__user__img">
                                    <div class="blog-card__user__info">
                                        <h3 class="blog-card__user__name">Ronald Richards</h3>
                                        <p class="blog-card__user__designation">Admin</p>
                                    </div>
